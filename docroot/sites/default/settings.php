...
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/segurosins/segurosins-settings.inc');
}
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_seguros_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_seguros_dd.inc';
}
// </DDSETTINGS>
$settings['http_client_config']['timeout'] = 220;
